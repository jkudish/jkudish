...
$allCompanies = [
    ...
    ['name' => 'Metorik', 'webp' => url('img/companies/metorik.webp'), 'png' => url('img/companies/metorik.png'), 'size' => 'max-h-10', 'classes' => $logoStyles['colorful']],
    ...
    ['name' => 'Spark Consulting', 'webp' => url('img/companies/spark-consulting.webp'), 'png' => url('img/companies/spark-consulting.png'), 'size' => 'max-h-20', 'classes' => $logoStyles['colorful']],
