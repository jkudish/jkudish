...
<div>
    ...
    <div class="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="text-center">
            <div class="text-3xl font-bold text-emerald-600 dark:text-emerald-300">
                {{ $metric['value'] }}
            </div>
    ...
    <div class="mt-16 grid gap-8 lg:grid-cols-2">
        ...
        <x-ui.gradient-border variant="primary" hover="false" padding="p-[1px]">
            <div class="p-6">
                <svg class="w-8 h-8 text-emerald-600 dark:text-emerald-300 opacity-20" fill="currentColor" viewBox="0 0 24 24">
