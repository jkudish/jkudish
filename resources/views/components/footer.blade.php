                ...
                <div class="flex justify-center space-x-6">
                    ...
                    >
                        <svg viewBox="0 0 600 530" aria-hidden="true"
                             class="h-6 w-6 fill-zinc-400 transition group-hover:fill-emerald-700">
                    ...
                    >
                        <svg viewBox="0 0 24 24" aria-hidden="true"
                             class="h-6 w-6 fill-zinc-400 transition group-hover:fill-emerald-700 border-2 border-zinc-400 dark:border-zinc-400 rounded-full group-hover:border-emerald-700">
                            <path fill-rule="evenodd" clip-rule="evenodd"
