        ...
        <div class="py-12 lg:py-16">
            <div class="grid grid-cols-2 gap-8 md:grid-cols-4 lg:gap-12">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-3" role="list">
                        <li>
                            <a href="mailto:joey@jkudish.com" class="text-zinc-300 hover:text-white transition-colors">
                                Email
                            </a>
                        </li>
                        <li>
                ...
                <div class="flex justify-center space-x-6">
                    ...
                    >
                        <svg viewBox="0 0 600 530" aria-hidden="true"
                             class="h-6 w-6 fill-zinc-400 transition group-hover:fill-teal-400">
                    ...
                    >
                        <svg viewBox="0 0 24 24" aria-hidden="true"
                             class="h-6 w-6 fill-zinc-400 transition group-hover:fill-teal-400 border-2 border-zinc-400 dark:border-zinc-400 rounded-full group-hover:border-teal-400">
                            <path fill-rule="evenodd" clip-rule="evenodd"
