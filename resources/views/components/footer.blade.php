                ...
                <div class="flex justify-center space-x-6">
                    ...
                    >
                        <svg viewBox="0 0 600 530" aria-hidden="true"
                             class="h-6 w-6 fill-zinc-400 transition group-hover:fill-emerald-400">
                    ...
                    >
                        <svg viewBox="0 0 24 24" aria-hidden="true"
                             class="h-6 w-6 fill-zinc-400 transition group-hover:fill-emerald-400 border-2 border-zinc-400 dark:border-zinc-400 rounded-full group-hover:border-emerald-400">
                            <path fill-rule="evenodd" clip-rule="evenodd"
