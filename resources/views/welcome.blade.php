    ...
    <div class="mt-6 flex gap-6">
        <a class="group -m-1 p-1" aria-label="Follow on Twitter / X" href="https://twitter.com/jkudish">
            <svg viewBox="0 0 24 24" aria-hidden="true"
                 class="h-6 w-6 fill-zinc-500 transition group-hover:fill-teal-400 dark:fill-zinc-400">
                <path
        ...
        <a class="group -m-1 p-1" aria-label="Follow on Pinkary" href="https://pinkary.com/@jkudish">
            <svg viewBox="0 0 24 24" aria-hidden="true"
                 class="h-6 w-6 fill-zinc-500 transition group-hover:fill-teal-400 dark:fill-zinc-400 border-2 border-zinc-500 dark:border-zin-400 rounded-full group-hover:border-teal-400">
                <path fill-rule="evenodd" clip-rule="evenodd"
