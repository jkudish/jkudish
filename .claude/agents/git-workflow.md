...
### Branch Naming
- Extract from spec folder: `2025-01-29-feature-name` → branch: `feat/feature-name`
...
- Be concise but provide enough context for a reviewer
- No need to be overly formal
- Never leave PR description blank
- Use markdown formatting for clarity
- Don't explain things that will be obvious to competent reviewers
